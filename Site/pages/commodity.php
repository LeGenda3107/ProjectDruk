...
if (isset($_GET['id'])) {
    ...
    $stmt = $conn->prepare("SELECT title, price, image_path FROM models WHERE model_id = ?");
...
<section class="container commodity">
  ...
  <h1 id="price"><?php echo $model['price'];?> грн</h1>
...
<script>
  // Дані для розмірів
  const sizeData = {
    S: { price: '<?php echo $model['price'];?> грн', size: '10-10-15см', weight: '32г', time: '3 год' },
    M: { price: '150 грн', size: '15-15-20см', weight: '50г', time: '4 год' },
    L: { price: '200 грн', size: '20-20-25см', weight: '80г', time: '5 год' }
  };
